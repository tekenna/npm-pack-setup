...
export class MyBtnTestComponent implements OnInit {
  classname =
  ...
  @Input('props') public props: IProps = {
      leftIcon: "",
      rightIcon: "",
      leftIconClass: "",
      rightIconClass: "",
  ...
  @Input('options') public options: IOptions = {
      type: "default",
      size: "default",
      class: "",
  };
  @Input('state') public state: IState = {
      loading: false,
      active: true,
  };
